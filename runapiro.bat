...
REM SET /a APIRO_REST_PORT=%APIRO_WEB_PORT%+1
REM SET /a APIRO_WS_PORT=%APIRO_WEB_PORT%+2

echo USING ENV FILE %FULLFILE%
echo COMPOSE NAME is %COMPOSE_NAME%
echo USING WEB PORTS %APIRO_SRV_PORT% - BROWSER TO localhost:%APIRO_SRV_PORT%
